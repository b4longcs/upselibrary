...
function enqueue_theme_assets() {
    ...
    wp_enqueue_style('google-fonts', 'https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800;900&display=swap&family=Roboto:wght@400;700&display=swap', array(), null, 'all');
    ...
    wp_enqueue_style('custom-pages-css', get_template_directory_uri() . '/assets/css/custom-pages.css', array(), null, 'all');
