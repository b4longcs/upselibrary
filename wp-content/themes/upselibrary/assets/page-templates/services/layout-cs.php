    ...
    <div class="circulation-item" data-scrollreveal="enter bottom over 1s and move 50px after 0.1s">
        <div class="circulation-grid-wrapper">
            <div class="circulation-grid-container">
                ...
                <p class="circ-content">10 circulation books for 2 weeks</p>
                <p class="circ-content">2 reserve books for overnight use</p>
            </div>
        </div>
    </div>
    ...
    <div class="circulation-item" data-scrollreveal="enter bottom over 1s and move 50px after 0.1s">
        <div class="circulation-grid-wrapper">
            <div class="circulation-grid-container">
                <div class="circulation-grid-content pb-2">
                    <i class="ri-layout-3-fill"></i>
                    <h3>RESEARCH, EXTENSION AND PROFESSIONAL STAFF (REPS)</h3>
                </div>
                <p class="circ-content">5 circulation books for 2 weeks</p>
                <p class="circ-content">2 reserve books for overnight use</p>
            </div>
            ...
            <div class="circ-left-hero" data-scrollreveal="enter bottom over 1s and move 50px after 0.1s">
                <div class="circulation-left-hero-content">
                    ...
                    <div class="numbered-paragraphs" data-scrollreveal="enter bottom over 1s and move 50px after 0.1s">
                        ...
                        <p>Wait for the staff-on-duty to retrieve the book you intend to borrow.</p>
                        <p>Fill out the book card. Once done, hand it over to the staff-on-duty.</p>
                        <p>Get your book.</p>
                    </div>
                    </p>
                </div>
                ...
                <div class="circulation-right-hero-content" data-scrollreveal="enter bottom over 1s and move 50px after 0.1s">
                    ...
                    <div class="subsubheader-circ">
                        ...
                        <div class="numbered-paragraphs" data-scrollreveal="enter bottom over 1s and move 50px after 0.1s">
                            ...
                            <p>Fill up reservation slip in ink giving complete information on the book/article being reserve for; write your name and student number legibly.</p>
                            <p>Reserve a book/article for each course at a time. However, a student is allowed a maximum of 3 reserve materials for overnight use.</p>
                            <p>Accomplished reservation slips should be submitted promptly approval. Students who day submitting their reservation slips may forfeit the number of their overnight reserve slip.</p>
                            <p>Reservations are non-transferrable. Only the student who placed reservation for the book is allowed to draw it out.</p>
                            <p>Approved reservations are retained at the Reserve Desk. Slips will closed reservations for the book is allowed to draw it out.</p>
                            <p><b>All reserve books must be returned on or before 9:00 a.m,</b> the following school day. <b>Reserve books returned after 9:00 a.m.</b> will be fined <b>P1.00</b> for the first hour or a fraction thereof; P5.00 for each hours after the first; and P50.00 for each full day. The student is barred from borrowing reserve materials for the rest of the semester or summer for a succeeding offense.</p>

                            <p><b>Reserve books are read within the reading room.</b> Taking a reserve material for outside use without permit (an approved reservation) will subject the students to a fine of <b>P50.00</b> and suspension of library privilege to borrow from the reserve collection for two weeks on second offense.</p>
                            <p>Reserve books stamped <b>Room Use Only</b> cannot be borrowed for overnight, however, required chapters needed in the course are available for overnight use.</p>
                        </div>    
                    </div>
                </div>
            </div>
