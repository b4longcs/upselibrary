...
<section class="global-pages-container align-items-center justify-content-between d-flex flex-wrap-reverse mt-5">
    ...
    <div class="global-left-hero" data-scrollreveal="enter bottom over 1s and move 50px after 0.1s">
        <div class="left-hero-header d-flex justify-content-center  flex-column" data-scrollreveal="enter bottom over 1s and move 50px after 0.1s">
            <p class="hero-header-one" data-scrollreveal="enter bottom over 1s and move 50px after 0.1s">Referral</p>
            <!-- <p class="hero-header-two">Loan</p> -->
        </div>
        <div class="left-hero-subsubheader my-3 w-75" data-scrollreveal="enter bottom over 1s and move 50px after 0.1s">
            <p class="content-text-custom bg-custom p-4" data-scrollreveal="enter bottom over 1s and move 50px after 0.1s">If ILL cannot be used to borrow the needed material/s from a partner library, the librarian can provide a referral letter to the user so s/he can personally visit the partner library and photocopy the material/s needed.</p>  
        </div>
    </div>
</section>
