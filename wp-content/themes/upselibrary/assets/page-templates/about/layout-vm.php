...
<section class="global-pages-container align-items-center justify-content-between d-flex flex-wrap my-5" data-scrollreveal="enter bottom over 1s and move 50px after 0.1s">
    ...
    <div class="global-right-hero" data-scrollreveal="enter bottom over 1s and move 50px after 0.1s">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/visionmission.svg" alt="Vission and Mission Image">
    </div>
</section>
    ...
    <div class="global-pages-container pt-5 px-lg-5 px-md-3 px-sm-2">
        ...
        <div class="global-pages-container">
            ...
            <article class="global-right-hero" data-scrollreveal="enter bottom over 1s and move 50px after 0.1s">
                    ...
                    <p class="subsubheader py-2 ms-lg-5 ms-md-3 ms-sm-1 me-5">• Ensure the preservation and long&#45;lasting availability of library collections and resources;</p>
                    <p class="subsubheader py-2 ms-lg-5 ms-md-3 ms-sm-1 me-5">• Create an area conducive to studying, teaching and research;</p>
                    <p class="subsubheader py-2 ms-lg-5 ms-md-3 ms-sm-1 me-5">• Participate in local and international network systems and exchange  programs and foster sharing of resources and transfer of information;</p>
                    <p class="subsubheader py-2 ms-lg-5 ms-md-3 ms-sm-1 me-5">• Enhance the skills and capabilities of the Library staff to become effective information providers and research facilitators.</p>
